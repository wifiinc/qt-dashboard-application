...
MainWindow::MainWindow(QWidget* parent)
    ...
    // ✅ Temperatuurconnectie
    connect(&client, &Tcpsocket::temperatuurOntvangen, this, &MainWindow::toonTemperatuur);
...
void MainWindow::toonTemperatuur(float waarde) {
    ui->labelTemperatuur->setText(QString::number(waarde, 'f', 1) + " °C");
}
...
void MainWindow::setSensorList()
{
    client.setSensorList({
        ...
        {SensorType::TEMPERATURE, 1} // ✅ Temperatuursensor ID (pas aan indien nodig)
    });
}
